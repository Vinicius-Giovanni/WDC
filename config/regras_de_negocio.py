"""
MOTIVOS_OFICIAIS = Armazena os motivos oficias, pelos quais os motivos da coluna 'motivos' serão tratados
MAPEAMENTO_TEXTUAL = Armazena os regex que vai tratar os items da coluna 'motivos'
REGRAS_DIRETAS = Armazena as palavras chaves que serão procuradas nos itens da coluna 'motivos'
"""
