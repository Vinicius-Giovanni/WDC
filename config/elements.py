...
ELEMENTS = Armazena as variaveis compostas pelos seletores dos elementos que serão localizados, lidos e controlados pela automação

LIST_FILIAL = Armazena a lista de filiais que a automação extrairá os arquivos

"""

LIST_FILIAL = [ # <-- Lista de filiais que a automação vai extrair os relatórios
    "1200"]

ELEMENTS = { # <-- caminho dos elementos do site, são usados para localizar e interagir com eles
